...
function SocialLink({ icon }: { icon: typeof socialIcons[0] }) {
  return (
    <a
      href={icon.href}
      target="_blank"
        ...
        <div className="px-6 pt-8 pb-4">
          ...
          <div className="flex flex-col items-center gap-4 mb-6">
            <Link href="/" className="flex-shrink-0">
              ...
              >
                <Image
                  src="/images/cindy-site-logo-footer.svg"
                  alt="Dr. Cindy"
                  fill
                ...
                <div className="px-6 py-4 border-t border-white/5 mt-auto">
                  <div className="flex flex-col items-center gap-2">
                    <p
                      ...
                      style={{ fontFamily: "var(--font-montserrat)" }}
                    >
                      © 2026 Dr. Cindy McGovern. All Rights Reserved.
                    </p>
      ...
      <div className="hidden md:block max-w-[1440px] mx-auto px-6 lg:px-[60px] pt-20 lg:pt-24 pb-10">
        ...
        <div className="flex flex-col items-center gap-6 mb-16">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-montserrat)" }}
          >
            Sales Is a Life Skill, Not a Business Skill.
          </p>
        </div>
